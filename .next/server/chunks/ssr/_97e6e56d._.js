...
"[project]/src/lib/backendService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchAuthenticated(url, options = {}) {
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__p__as__getAuth$3e$__["getAuth"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFirebaseApp"])());
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/backendService.ts [app-ssr] (ecmascript)");
...
function DashboardPage() {
    ...
    const fetchWorkflows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!user) return;
        setLoading(true);
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAuthenticated"])('/api/workflows');
    ...
    const handleStatusToggle = async (workflowId, isEnabled)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAuthenticated"])(`/api/workflows/${workflowId}`, {
                method: 'PATCH',
                body: JSON.stringify({
                    isEnabled: !isEnabled
                })
...
//# sourceMappingURL=_97e6e56d._.js.map