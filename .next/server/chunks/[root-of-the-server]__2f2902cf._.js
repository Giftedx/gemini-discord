...
"[project]/.next-internal/server/app/api/workflows/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/workflows/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getGuildsForUser(uid) {
...
async function GET() {
    const authorization = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["headers"])().get('Authorization');
    ...
    try {
        ...
        // }
        const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["firestore"].collection(WORKFLOWS_COLLECTION).get();
        const workflows = [];
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(workflows);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f2902cf._.js.map