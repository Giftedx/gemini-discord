    ...
    try {
        ...
        const tokenResponse = await fetch('https://discord.com/api/oauth2/token', {
            ...
            body: new URLSearchParams({
                ...
                code,
                redirect_uri: `${("TURBOPACK compile-time value", "http://localhost:9002")}/api/auth/discord/callback`
            })
        });
        if (!tokenResponse.ok) {
        ...
        const customToken = await __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin__$5b$external$5d$__$28$firebase$2d$admin$2c$__cjs$29$__$3c$export__$2a$__as__admin$3e$__["admin"].auth().createCustomToken(userData.id);
        // 4. Redirect to a frontend page with the custom token
        const redirectUrl = new URL('/auth/verify', ("TURBOPACK compile-time value", "http://localhost:9002"));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c50ed48e._.js.map