...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyDYuik86vMNMA4-LAmz8lwXDltEoO28G1M"),
    authDomain: ("TURBOPACK compile-time value", "gemini-discord-y7ktf.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "gemini-discord-y7ktf"),
    storageBucket: ("TURBOPACK compile-time value", "gemini-discord-y7ktf.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "299683230639"),
    appId: ("TURBOPACK compile-time value", "1:299683230639:web:47dc0868d3d3801b94f55a")
};
const isFirebaseConfigured = !!firebaseConfig.apiKey && !!firebaseConfig.authDomain && !!firebaseConfig.projectId && !!firebaseConfig.storageBucket && !!firebaseConfig.messagingSenderId && !!firebaseConfig.appId;
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"]) {
            ...
            let unsubscribe;
            try {
                const app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseApp"])();
                ...
                unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(authInstance, {
    ...
    const value = {
        ...
        loading,
        logout,
        isFirebaseConfigured: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"],
        error
    };
...
_s(AuthProvider, "Ag0MoN8RyOaluwC5hOpkmbW/vfE=", false, function() {
    return [
...
//# sourceMappingURL=src_ce78fbe3._.js.map